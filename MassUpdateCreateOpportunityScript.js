 ...
 */
	...
	function createTrialOpportunityEntry(recordType,recordId)
	{
		...
		{
			errorHandler('createTrialOpportunityEntry', e);
		}
	}
	...
	function getOpportunityDetails(record)
	{
		...
		{
			errorHandler('getOpportunityDetails', e);
		}
	...
	{		
		...
		try
		{
			QUANTITY_VALUE = Number(lookUpParameters('Search', 'Quantity Value'));	//1.0.1
			lines = details.items;	
		...
		{
			errorHandler('createOpportunity', e);
		}
	}
