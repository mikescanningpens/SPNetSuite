...
var ValidateSalesOrder = function(Library)
{
	...
	function isFulfillFromColumnPopulated()
	{
		...
		try
		{
			populated = true;
				...
				fulfillFrom = nlapiGetCurrentLineItemValue('item', 'custcol_fulfill_from');
	 ...
	 */
	function validateLineMandatory()
	{
		...
		try
		{
			...
			if (isFulfillFromMandatory() && !isFulfillFromColumnPopulated() && customForm == '117')
			{
	...
	return {
		...
		validateLine: validateLineMandatory,
